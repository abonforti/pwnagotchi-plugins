...
| [`pisugar_custom_button.py`](pisugar_custom_button.py) | Reads the PiSugar custom button and emits a plugin event for each gesture; only the long press is bound |
